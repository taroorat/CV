// 需要有这个 tac 全局变量, 才能生成正确的 signature, 源码中正则匹配获取, 变化值为前半部分
var tac = 'i)69mrlfw5os!i#trzs"0' + ',<8~z|\x7f@QGNCJF[\\\\^D\\\\KFYSk~^WSZhg,(lfi~ah`{md"inb|1d<,%Dscafgd"in,8[xtm}nLzNEGQMKAdGG^NTY\x1ckgd"inb<b|1d<g,&TboLr{m,(\x02)!jx-2n&vr$testxg,%@tug{mn ,%vrfkbm[!cb|';
...
console.log(generateSignature(58762488923));
